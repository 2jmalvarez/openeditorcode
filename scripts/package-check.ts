...
const packages = [
  { directory: ".", required: ["bin/oec.js", "bin/launcher.js", "docs/manual.md", "docs/oec-config.schema.json", "man/oec.1", "man/openeditorcode.1", "LICENSE", "README.md", "README.es.md", "package.json"] },
